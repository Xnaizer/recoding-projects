                ...
                <nav className="p-5 xl:px-7 w-full fixed z-50 bg-slate-800" id="navbar">
                    <div className="flex container justify-between mx-auto items-center pl-6">
                        ...
                        <div className="flex items-center lg:gap-5 xl:gap-10">
                            <a
                                href="/"
                                className="flex gap-2 items-center hover:text-slate-200"
                            >
                                <img
                                    src={logoNavbar}
                                    alt="double-paw"
                        ...
                        <div className="hidden md:block max-w-sm">
                            <h1 className="text-md font-semibold text-white" aria-live="polite">
                                {`AdoptPet's, ${text}! `}
                        ...
                        <div className="flex items-center gap-4 p-4">
                            <ul className="hidden lg:flex items-center gap-7 xl:gap-9">
                                ...
                                <li>
                                    <a
                                        href="#"
                                        className="px-8 py-3 rounded-md bg-slate-600 font-medium text-white hover:bg-red-600"
                                    >
                                        Log Out
                                    </a>
                                </li>
                            ...
                            <div className="fixed inset-0 bg-slate-800 z-40 lg:hidden">
                                <div className="flex flex-col items-center justify-center h-full px-5 relative">
                                    ...
                                    <div className="flex flex-col items-center gap-5">
                                        ...
                                        <a 
                                        href="/"
                                        className="font-Sawa text-paleBlue text-3xl font-bold text-white mb-4">
                                            AdoptPets
                                        </a>
                                    </div>
                                    <input
                                    ...
                                    />
                                    <button
                                        className="w-1/2 text-center text-black bg-white rounded-md font-Sawa py-3 px-8 my-6"
                                    >
                                        Search
                                    </button>

                                    <button
                                        className="w-3/4 text-center text-black bg-white rounded-md font-Sawa py-3 px-8"
                                    >
                                        Log Out
                                    </button>
                                </div>
